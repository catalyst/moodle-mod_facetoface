...
class delete_session_failed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' tried to delete a session with id '$this->objectid' in the facetoface instance " .
    ...
    public static function get_name() {
        return get_string('eventdeletesessionfailed', 'mod_facetoface');
    }
