...
$string['setting:sessioncompletiondate'] = 'When enabled, the session start date will be used as the completion time when marking attendance.';
$string['setting:sessioncompletiondate_caption'] = 'Use session date for completion:';
